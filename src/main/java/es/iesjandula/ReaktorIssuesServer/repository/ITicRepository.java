...
public interface ITicRepository extends JpaRepository<Tic, String>
{
	...
	@Query("SELECT new es.iesjandula.ReaktorIssuesServer.models.Tic(t.id, t.correo, t.numeroAula, t.nombreProfesor, t.fechaDeteccion, t.descripcionIncidencia, t.estado, t.finalizadaPor, t.solucion) FROM Tic t")
